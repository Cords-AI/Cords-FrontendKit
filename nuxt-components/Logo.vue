<template>
  <svg class="cords-logo" xmlns="http://www.w3.org/2000/svg" width="60" height="18" viewBox="0 0 60 18">
...
.cords-logo {
  --logo-color-default: currentColor;
  fill: var(--logo-color, var(--logo-color-default));
}
</style>
